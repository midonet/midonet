...
class MidonetApi(object):
    ...
    def __init__(
            self, base_uri, username, password, project_id=None,
    ...
    def delete_qos_bwlimit_rule(self, id_):
        self._ensure_application()
        return self.app.delete_qos_bwlimit_rule(id_)

    def get_qos_bwlimit_rule(self, id_):
        self._ensure_application()
        return self.app.get_qos_bwlimit_rule(id_)
    ...
    def add_qos_bwlimit_rule(self, qos_policy, max_kbps=0, max_burst=0):
        return (qos_policy.add_bwlimit_rule()
                .max_kbps(max_kbps)
