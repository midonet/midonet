...
class MidonetApi(object):
    ...
    def get_host_group(self, id_):
        self._ensure_application()
        return self.app.get_host_group(id_)

    def get_host_groups(self, query=None):
        if query is None:
            query = {}
        self._ensure_application()
        return self.app.get_host_groups(query)
    ...
    def add_host_group(self):
        self._ensure_application()
        return self.app.add_host_group()

    def delete_host_group(self, id_):
        self._ensure_application()
        return self.app.delete_host_group(id_)
