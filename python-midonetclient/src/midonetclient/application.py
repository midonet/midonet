...
from midonetclient import qos_rule_bwlimit
...
class Application(resource_base.ResourceBase):
    ...
    def get_qos_bwlimit_rule_template(self):
    ...
    def delete_qos_bwlimit_rule(self, id_):
        return self._delete_resource_by_id(
            self.get_qos_bwlimit_rule_template(), id_)

    def get_qos_bwlimit_rule(self, id_):
        return self._get_resource_by_id(
            qos_rule_bwlimit.QOSRuleBWLimit, None,
            self.get_qos_bwlimit_rule_template(), id_)
