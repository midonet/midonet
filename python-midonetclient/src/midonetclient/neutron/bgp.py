...
class BgpClientMixin(BGPUrlProviderMixin):
    ...
    def create_bgp_speaker(self, bgp_speaker):
        LOG.info("create_bgp_speaker %r", bgp_speaker)
        return self.client.post(self.bgp_speakers_url(),
                                media_type.BGP_SPEAKER,
                                body=bgp_speaker)

    def delete_bgp_speaker(self, bgp_speaker_id):
        LOG.info("delete_bgp_speaker %r", bgp_speaker_id)
        self.client.delete(self.bgp_speaker_url(bgp_speaker_id))
