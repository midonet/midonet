...
/**
  * This trait allows a [[ByteBufferBlock]] to handle block
  ...
  */
trait TimedBlockInvalidator[T <: TimedBlockHeader]
    extends ByteBufferBlock[T] {

    /** Expiration time in nanoseconds, same precision as used by [[NanoClock.DEFAULT]]. */
