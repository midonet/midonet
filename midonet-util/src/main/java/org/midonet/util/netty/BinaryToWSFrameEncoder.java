...
/**
 * Encapsulate a binary protocol buffer into a websocket binary frame
 * Note: this is intended for protocol buffer encodings, but it should work
 * for any byte buffer containing binary data.
 */
