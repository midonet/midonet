...
public class FlowStateEthernet extends Ethernet {
    ...
    public final static int GRE_ENCAPUSULATION_OVERHEAD =
            IPv4.MIN_HEADER_LEN + GRE.MIN_HEADER_LEN + GRE.KEY_LEN;
    // 20(IP) + 8(UDP) + 8(VXLAN)
    public final static int VXLAN_ENCAPUSULATION_OVERHEAD =
            IPv4.MIN_HEADER_LEN + UDP.HEADER_LEN + 8;
    ...
    public final static short FLOW_STATE_IDENTIFICATION = (short) 0x01;
    public final static byte FLOW_STATE_IP_VERSION = (byte) 0x04;
    public final static byte FLOW_STATE_IP_HEADER_LENGTH = (byte) 0x05;
    public final static byte FLOW_STATE_DIFF_SERV = (byte) 0x00;
    public final static byte FLOW_STATE_FLAGS = (byte) 0b010;
    public final static short FLOW_STATE_FRAGMENT_OFFSET =
            (short) 0b1111111111111;
    public final static byte FLOW_STATE_TTL = (byte) 0x01;
    public final static byte FLOW_STATE_UDP_PROTOCOL = (byte) 0x11;
    ...
    private static void putFlowStateEthernetHeader() {
        ...
        ipv4.setDiffServ(FlowStateEthernet.FLOW_STATE_DIFF_SERV);
        ipv4.setTotalLength(IPv4.MIN_HEADER_LEN);
        ipv4.setIdentification(FlowStateEthernet.FLOW_STATE_IDENTIFICATION);
        ipv4.setFlags(FlowStateEthernet.FLOW_STATE_FLAGS);
        ipv4.setFragmentOffset(FlowStateEthernet.FLOW_STATE_FRAGMENT_OFFSET);
        ipv4.setTtl(FlowStateEthernet.FLOW_STATE_TTL);
        ipv4.setProtocol(FlowStateEthernet.FLOW_STATE_UDP_PROTOCOL);
