...
public class BPDU extends BasePacket {
    ...
    public final static byte FLAG_MASK_802_1D_TOPOLOGY_CHANGE = (byte) (1 << 0);
    public final static byte FLAG_MASK_802_1D_TOPOLOGY_CHANGE_ACK = (byte) (1 << 7);

    public final static byte FLAG_MASK_DEC_TOPOLOGY_CHANGE = (byte) (1 << 0);
    public final static byte FLAG_MASK_DEC_1D_TOPOLOGY_CHANGE_ACK = (byte) (1 << 1);

    public final static byte SAP = 0x42;
    ...
    private byte topologyChangeMask = FLAG_MASK_DEC_TOPOLOGY_CHANGE;
    private byte topologyChangeAckMask = FLAG_MASK_DEC_1D_TOPOLOGY_CHANGE_ACK;
    ...
    public IPacket deserialize(ByteBuffer bb) throws MalformedPacketException {
        ...
        try {
            type = bb.get();
            if (type == SAP && (type = bb.get()) == SAP) {
                // Packet is LLC encapsulated
                bb.get(); // ignore control field
                type = bb.get();
            }
            if (type == DEC_CODE)
        ...
        throw new MalformedPacketException("Unknown BPDU packet type " + type);
    }
