...
public class IfTest {
    ...
    public void testIfMapWrite() {
        ...
        ifMap.memStart = 0x0001020304050607L;
        ifMap.memEnd = 0x08090A0B0C0D0E0FL;
    ...
    public void testIfMapRead() {
        ...
        Assert.assertEquals(ifMap.memStart, 0x0001020304050607L);
        Assert.assertEquals(ifMap.memEnd, 0x08090A0B0C0D0E0FL);
