...
public class TestTCP {
    ...
    private static byte[] tcpWithChecksumIpv6 = new byte[] {
            (byte) 0x60, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00,
            (byte) 0x14, (byte) 0x06, (byte) 0x40, (byte) 0x20, (byte) 0x01,
            (byte) 0x06, (byte) 0xf8, (byte) 0x10, (byte) 0x2d, (byte) 0x00,
            (byte) 0x00, (byte) 0x02, (byte) 0xd0, (byte) 0x09, (byte) 0xff,
            (byte) 0xfe, (byte) 0xe3, (byte) 0xe8, (byte) 0xde, (byte) 0x20,
            (byte) 0x01, (byte) 0x06, (byte) 0xf8, (byte) 0x09, (byte) 0x00,
            (byte) 0x07, (byte) 0xc0, (byte) 0x00, (byte) 0x00, (byte) 0x00,
            (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x02,
            (byte) 0xe7, (byte) 0x41, (byte) 0x00, (byte) 0x50, (byte) 0xab,
            (byte) 0xdc, (byte) 0xd6, (byte) 0x61, (byte) 0x01, (byte) 0x4a,
            (byte) 0x73, (byte) 0x9f, (byte) 0x50, (byte) 0x10, (byte) 0x16,
            (byte) 0x80, (byte) 0x57, (byte) 0x28, (byte) 0x00, (byte) 0x00
    };

    public static class TestTcpChecksumCalculation {

        @Test
        public void testIpv4() throws MalformedPacketException {
            IPv4 ipPkt = new IPv4();
        ...
        @Test
        public void testIpv6() throws MalformedPacketException {
            IPv6 ipPkt = new IPv6();
            ipPkt.deserialize(ByteBuffer.wrap(tcpWithChecksumIpv6));
            TCP tcp = (TCP)ipPkt.getPayload();
            tcp.clearChecksum();
            byte[] serializedTcpWithChecksum = ipPkt.serialize();
            assertArrayEquals(tcpWithChecksumIpv6, serializedTcpWithChecksum);
        }
    }
