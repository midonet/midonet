...
public class TestRouteResource {
    ...
    public void setUp() throws Exception {
        testObject = new RouteResource();
        doReturn(dao).when(factory).getRouteDao();
    }
    ...
    public void testDeleteUnauthorized() throws Exception {
        ...
        doReturn(false).when(auth).routeAuthorized(context, AuthAction.WRITE,
                id);
    ...
    public void testDeleteNonExistentData() throws Exception {
        // Set up
        UUID id = UUID.randomUUID();
        doReturn(true).when(auth).routeAuthorized(context, AuthAction.WRITE,
                id);
    ...
    public void testGetUnauthorized() throws Exception {
        // Set up
        UUID id = UUID.randomUUID();
        doReturn(false).when(auth).routeAuthorized(context, AuthAction.READ,
                id);
