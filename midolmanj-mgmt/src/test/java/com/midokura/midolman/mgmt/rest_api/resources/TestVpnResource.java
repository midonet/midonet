...
public class TestVpnResource {
    ...
    private VpnResource testObject;
    ...
    public void setUp() throws Exception {
        testObject = new VpnResource();
        doReturn(dao).when(factory).getVpnDao();
    }
    ...
    public void testDeleteUnauthorized() throws Exception {
        ...
        doReturn(false).when(auth).vpnAuthorized(context, AuthAction.WRITE,
                id);
    ...
    public void testDeleteNonExistentData() throws Exception {
        // Set up
        UUID id = UUID.randomUUID();
        doReturn(true).when(auth).vpnAuthorized(context, AuthAction.WRITE,
                id);
    ...
    public void testGetUnauthorized() throws Exception {
        // Set up
        UUID id = UUID.randomUUID();
        doReturn(false).when(auth).vpnAuthorized(context, AuthAction.READ,
                id);
