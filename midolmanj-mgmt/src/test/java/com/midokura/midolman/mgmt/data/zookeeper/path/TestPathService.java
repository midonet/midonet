...
public class TestPathService {
    ...
    public void testGetInitialPaths() throws Exception {
        ...
        Assert.assertEquals(23, paths.length);
        ...
        Assert.assertEquals(rootPath + "/ports", paths[10]);
        Assert.assertEquals(rootPath + "/routers", paths[11]);
        Assert.assertEquals(rootPath + "/routes", paths[12]);
        Assert.assertEquals(rootPath + "/rules", paths[13]);
        Assert.assertEquals(rootPath + "/vpn", paths[14]);
        Assert.assertEquals(rootPath + "/vrn_port_locations", paths[15]);

        Assert.assertEquals(altRootPath, paths[16]);
        Assert.assertEquals(altRootPath + "/bridges", paths[17]);
        Assert.assertEquals(altRootPath + "/chains", paths[18]);
        Assert.assertEquals(altRootPath + "/ports", paths[19]);
        Assert.assertEquals(altRootPath + "/routers", paths[20]);
        Assert.assertEquals(altRootPath + "/tenants", paths[21]);
        Assert.assertEquals(altRootPath + "/vifs", paths[22]);
