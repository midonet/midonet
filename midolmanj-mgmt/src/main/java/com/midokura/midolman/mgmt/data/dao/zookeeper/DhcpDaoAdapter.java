...
public class DhcpDaoAdapter implements DhcpDao {
	private final static Logger log = LoggerFactory
			.getLogger(DhcpDaoAdapter.class);

	private final BridgeDhcpZkManager dhcpMgr;

	public DhcpDaoAdapter(BridgeDhcpZkManager dhcpMgr) {
	...
	public List<DhcpHost> getHosts(UUID bridgeId, IntIPv4 subnet)
			throws StateAccessException {
		log.debug("DhcpDaoAdapter.getHosts: entered with bridge: " + bridgeId);
