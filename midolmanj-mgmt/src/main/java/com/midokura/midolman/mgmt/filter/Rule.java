...
public abstract class Rule extends UriResource {
     ...
     *            Rule data object
     */
    public Rule(com.midokura.midonet.cluster.data.Rule data) {
    ...
    public abstract com.midokura.midonet.cluster.data.Rule toData();

    protected void setData(com.midokura.midonet.cluster.data.Rule data) {
        data.setId(id);
