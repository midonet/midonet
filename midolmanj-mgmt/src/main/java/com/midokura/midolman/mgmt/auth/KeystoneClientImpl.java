 ...
 * @author Ryu Ishimoto
 */
public final class KeystoneClientImpl implements KeystoneClient {
    /*
     * Implements Keystone authentication methods.
     */

    private final static Logger log = LoggerFactory
            .getLogger(KeystoneClientImpl.class);
     ...
     */
    public KeystoneClientImpl(String protocol, String host, int port) {
