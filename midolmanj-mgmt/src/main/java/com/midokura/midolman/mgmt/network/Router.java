...
import com.midokura.midolman.mgmt.network.Router.RouterExtended;
import com.midokura.midolman.mgmt.UriResource;
import com.midokura.midolman.mgmt.ResourceUriBuilder;
import com.midokura.midolman.mgmt.network.validation.IsUniqueRouterName;
...
public class Router extends UriResource {
     ...
     *            Router data object
     */
    public Router(com.midokura.midonet.cluster.data.Router routerData) {
     ...
     */
    public com.midokura.midonet.cluster.data.Router toData() {

        return new com.midokura.midonet.cluster.data.Router()
                .setId(this.id)
                .setName(this.name)
