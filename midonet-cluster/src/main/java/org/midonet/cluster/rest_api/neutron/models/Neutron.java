...
public class Neutron {
    ...
    @JsonProperty("load_balancer_v2_template")
    public String loadBalancerV2Template;

    @JsonProperty("pool_v2")
    public URI poolsV2;

    @JsonProperty("pools_v2_template")
    public String poolV2Template;

    @JsonProperty("pool_member_v2")
    public URI poolMembersV2;

    @JsonProperty("pool_members_v2_template")
    ...
    @JsonProperty("health_monitor_v2_template")
