...
public class HealthMonitorV2Resource {
    ...
    @GET
    @Path("{id}")
    @Produces(NeutronMediaType.HEALTH_MONITOR_V2_JSON_V1)
    ...
    @GET
    @Produces(NeutronMediaType.HEALTH_MONITORS_V2_JSON_V1)
    public List<HealthMonitorV2> list() {
        return api.getHealthMonitorsV2();
    }

    @POST
    @Consumes(NeutronMediaType.HEALTH_MONITOR_V2_JSON_V1)
    @Produces(NeutronMediaType.HEALTH_MONITOR_V2_JSON_V1)
