...
public class NeutronUriBuilder {
    ...
    public static final String LBS_V2 = "/lbs_v2";
    public static final String LISTENERS_V2 = "/listeners_v2";
    ...
    public static URI getListenersV2(URI baseUri) {
        return UriBuilder.fromUri(getNeutron(baseUri)).path(LISTENERS_V2).build();
    }
