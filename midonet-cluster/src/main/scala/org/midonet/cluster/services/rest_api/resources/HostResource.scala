...
import org.midonet.cluster.rest_api.annotation.{AllowCreate, AllowGet, AllowList, ApiResource}
import org.midonet.cluster.rest_api.models.{Host, HostState, Interface, TunnelZone}
