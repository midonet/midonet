...
object MidonetMediaTypes {
    ...
    final val NEUTRON_IPSEC_SITE_CONNECTION_JSON_V1 = "application/vnd.org.midonet.neutron.IpsecSiteConnection-v1+json"
    ...
    final val NEUTRON_REMOTE_MAC_ENTRY_JSON_V1 = "application/vnd.org.midonet.neutron.RemoteMacEntry-v1+json"
    final val NEUTRON_REMOTE_MAC_ENTRIES_JSON_V1 = "application/vnd.org.midonet.neutron.RemoteMacEntries-v1+json"
    ...
    final val NEUTRON_FIREWALL_LOG_JSON_V1 = "application/vnd.org.midonet.neutron.FirewallLog-v1+json"
    ...
    final val APPLICATION_BRIDGE_JSON_V5 = "application/vnd.org.midonet.Bridge-v5+json"
    final val APPLICATION_BRIDGE_COLLECTION_JSON_V5 = "application/vnd.org.midonet.collection.Bridge-v5+json"
    ...
    final val APPLICATION_PORT_V4_JSON = "application/vnd.org.midonet.Port-v4+json"
    final val APPLICATION_PORT_V4_COLLECTION_JSON = "application/vnd.org.midonet.collection.Port-v4+json"
    ...
    final val APPLICATION_QOS_POLICY_COLLECTION_JSON = "application/vnd.org.midonet.collection.QOSPolicy-v1+json"
    final val APPLICATION_QOS_RULE_BW_LIMIT_JSON = "application/vnd.org.midonet.QOSRuleBWLimit-v1+json"
    final val APPLICATION_QOS_RULE_BW_LIMIT_COLLECTION_JSON = "application/vnd.org.midonet.collection.QOSRuleBWLimit-v1+json"
    final val APPLICATION_QOS_RULE_DSCP_JSON = "application/vnd.org.midonet.QOSRuleDSCP-v1+json"
    final val APPLICATION_QOS_RULE_DSCP_COLLECTION_JSON = "application/vnd.org.midonet.collection.QOSRuleDSCP-v1+json"
