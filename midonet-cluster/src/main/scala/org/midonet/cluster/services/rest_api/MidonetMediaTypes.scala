...
object MidonetMediaTypes {
    ...
    @Relative final val APPLICATION_BRIDGE_JSON_V5 = "application/vnd.org.midonet.Bridge-v5+json"
    final val APPLICATION_BRIDGE_COLLECTION_JSON_V4 = "application/vnd.org.midonet.collection.Bridge-v4+json"
    @Relative final val APPLICATION_BRIDGE_COLLECTION_JSON_V5 = "application/vnd.org.midonet.collection.Bridge-v5+json"
