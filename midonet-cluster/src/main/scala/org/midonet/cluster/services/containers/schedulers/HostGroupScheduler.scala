...
class HostGroupScheduler @Inject()(store: Storage, stateStore: StateStorage)
    ...
    // TODO: add a hostgroup observer to get notifications of hostgroup membership changes
}
