...
object NeutronDeserializer {
    ...
    private def parseNestedMsg(desc: Descriptor)(node: JsonNode): Message = {
        ...
        desc.getFullName match {
            case "org.midonet.cluster.models.IPSecSiteConnection.IkePolicy" =>
                toMessage(node, classOf[IPSecSiteConnection.IkePolicy])
            case "org.midonet.cluster.models.IPAddress" =>
                parseIpAddr(node.asText)
            case "org.midonet.cluster.models.IPSecSiteConnection.IPSecPolicy" =>
            ...
            case "org.midonet.cluster.models.FirewallLog" =>
                toMessage(node, classOf[FirewallLog])
            ...
            case "org.midonet.cluster.models.NeutronLoadBalancerV2Pool" =>
                toMessage(node, classOf[NeutronLoadBalancerV2Pool])
