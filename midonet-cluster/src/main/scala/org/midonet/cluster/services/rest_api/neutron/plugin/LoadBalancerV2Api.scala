...
trait LoadBalancerV2Api {
    ...
    @throws(classOf[ConflictHttpException])
    @throws(classOf[NotFoundHttpException])
    def getListenerV2(id: UUID): LBListenerV2

    @throws(classOf[ConflictHttpException])
    @throws(classOf[NotFoundHttpException])
    def getListenersV2: util.List[LBListenerV2]

    @throws(classOf[ConflictHttpException])
    @throws(classOf[NotFoundHttpException])
    def createListenerV2(l: LBListenerV2): LBListenerV2

    @throws(classOf[ConflictHttpException])
    @throws(classOf[NotFoundHttpException])
    def updateListenerV2(id: UUID, l: LBListenerV2): LBListenerV2
