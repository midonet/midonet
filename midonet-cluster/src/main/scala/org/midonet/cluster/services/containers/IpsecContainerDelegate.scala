...
import org.midonet.cluster.models.Topology.{ServiceContainerGroup, Host, Port, ServiceContainer}
...
class IpsecContainerDelegate @Inject()(store: Storage)
    ...
    /**
      ...
      * name.
      */
    override def onScheduled(container: ServiceContainer, group: ServiceContainerGroup,
                             hostId: UUID): Unit = {
    ...
    override def onUp(container: ServiceContainer, group: ServiceContainerGroup,
        ...
        // TODO: this method should setup the vpn health check for fast failover
    }
    ...
    /**
      ...
      * has been deleted.
      */
    override def onDown(container: ServiceContainer, group: ServiceContainerGroup,
                        status: ContainerStatus): Unit = {
        // TODO: this method should tear down whatever was set up during onUp
        // only health monitoring for fast failover right now
    }
    ...
    /**
      ...
      */
    override def onUnscheduled(container: ServiceContainer, group: ServiceContainerGroup,
                               hostId: UUID): Unit = {
