...
class NeutronResource @Inject()(uriInfo: UriInfo,
    ...
    @Produces(Array(MidonetMediaTypes.NEUTRON_JSON_V3)) def get: Neutron = {
        ...
        neutron.loadBalancerV2Template = getLoadBalancerV2Template(baseUri)
        neutron.poolsV2 = getPoolsV2(baseUri)
        neutron.poolV2Template = getPoolV2Template(baseUri)
        neutron.poolMembersV2 = getPoolMembersV2(baseUri)
        neutron.poolMemberV2Template = getPoolMemberV2Template(baseUri)
        neutron.listenersV2 = getListenersV2(baseUri)
        neutron.listenerV2Template = getListenerV2Template(baseUri)
        neutron.healthMonitorsV2 = getHealthMonitorsV2(baseUri)
        neutron.healthMonitorV2Template = getHealthMonitorV2Template(baseUri)
