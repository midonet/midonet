...
class NeutronTranslatorManager(config: ClusterConfig,
    ...
    private val translators = Map[Class[_], Translator[_]](
        ...
        classOf[NeutronHealthMonitorV2] -> new HealthMonitorV2Translator(),
        classOf[NeutronLoadBalancerPool] -> new LoadBalancerPoolTranslator(),
        classOf[NeutronLoadBalancerV2] -> new LoadBalancerV2Translator(config),
        classOf[NeutronLoadBalancerV2Listener] -> new ListenerV2Translator(),
        classOf[NeutronLoadBalancerV2Pool] -> new LoadBalancerV2PoolTranslator(),
        classOf[NeutronLoadBalancerV2PoolMember] -> new LoadBalancerV2PoolMemberTranslator(),
