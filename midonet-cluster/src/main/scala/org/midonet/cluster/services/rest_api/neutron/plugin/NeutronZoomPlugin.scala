...
class NeutronZoomPlugin @Inject()(resourceContext: ResourceContext,
    ...
    override def getListenerV2(id: UUID): LBListenerV2 = get[LBListenerV2](id)

    override def getListenersV2: util.List[LBListenerV2] = listAll(classOf[LBListenerV2])

    override def createListenerV2(l: LBListenerV2): LBListenerV2 = create(l)

    override def updateListenerV2(id: UUID, l: LBListenerV2): LBListenerV2 = {
        l.id = id
        update(l)
    }

    override def deleteListenerV2(id: UUID) = delete(id, classOf[LBListenerV2])
