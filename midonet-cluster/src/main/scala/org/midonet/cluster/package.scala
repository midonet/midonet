...
package object cluster {
    ...
    final val c3poNeutronDeserializerLog =
        "org.midonet.cluster.services.c3po.c3po-neutron-deserializer"
    final val c3poStorageManagerLog =
        "org.midonet.cluster.services.c3po.c3po-storage-manager"
    def c3poNeutronTranslatorLog(clazz: Class[_]) =
        s"org.midonet.cluster.services.c3po.c3po-${clazz.getSimpleName}"
