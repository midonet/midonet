...
import org.midonet.cluster.util.{IPSubnetUtil, UUIDUtil, IPAddressUtil}
...
class FloatingIpTranslatorIT extends C3POMinionTestBase with ChainManager {
    ...
    "C3PO" should "add NAT rules and ARP entry for the floating IP." in {
        ...
        val vifPortId = createVifPort(
            30, privateNwId, privateSnId, fixedIp, mac = vifPortMac)
        ...
        val vifPort2Id = createVifPort(140, privateNwId, extSubnetId,
                                       vifPort2FixedIp, mac = vifPort2Mac)
    ...
    it should "select the router port whose subnet contains the FIP" in {
        ...
        val vifIp1 = "30.0.0.3"
        val vifIp2 = "30.0.0.4"
        val vifPort1Id = createVifPort(70, prvNwId, prvNwSnId, vifIp1)
        val vifPort2Id = createVifPort(80, prvNwId, prvNwSnId, vifIp2)
        ...
        eventually {
            val prvNwRifPeerPortId =
                routerInterfacePortPeerId(UUIDUtil.toProto(prvNwRifPortId))
