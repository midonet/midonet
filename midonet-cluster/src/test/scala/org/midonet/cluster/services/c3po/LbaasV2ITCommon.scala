...
trait LbaasV2ITCommon { this: C3POMinionTestBase =>
    ...
    protected def createVipV2Port(networkId: UUID, subnetId: UUID,
                                  ipAddr: String,
    ...
    protected def createVipV2PortAndNetwork(ipAddr: String = "10.0.1.4",
    ...
    (UUID, UUID, UUID) = {
        ...
        insertCreateTask(30, PortType, json, portId)
        (createVipV2Port(vipNetworkId, vipSubnetId, ipAddr, portId),
            vipNetworkId,
            vipSubnetId)
    }
