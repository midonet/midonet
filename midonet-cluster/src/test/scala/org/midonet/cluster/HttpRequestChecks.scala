...
trait HttpRequestChecks extends JerseyTest with ShouldMatchers {
    ...
    /**
      * Assert a successful POST the given DTO to the base resource URI.
      *
      * @param dto the DTO
    ...
    def postAndAssertOk(dto: UriResource,
        ...
        postResp.getStatus shouldBe Status.NO_CONTENT.getStatusCode
    ...
    /** Assert a successful GET the resource at the given DTO, checking that
      * the relevant headers are set correctly.
      */
