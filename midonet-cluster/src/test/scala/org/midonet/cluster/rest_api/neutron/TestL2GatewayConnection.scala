...
import org.midonet.cluster.rest_api.neutron.models.GatewayDevice.GatewayType
import org.scalatest.junit.JUnitRunner
import org.scalatest.{BeforeAndAfter, FeatureSpec, Matchers}

import org.midonet.cluster.rest_api.neutron.models.{GatewayDevice, L2Gateway, L2GatewayConnection, Neutron}
...
class TestL2GatewayConnection extends FeatureSpec
    ...
    scenario("Create, Read, Delete") {
        ...
        l2GwConn.l2Gateway = new L2Gateway()
        l2GwConn.l2Gateway.name = "l2gw-name"
        l2GwConn.l2Gateway.deviceId = UUID.randomUUID
        l2GwConn.l2Gateway.gatewayDevice = new GatewayDevice()
        l2GwConn.l2Gateway.gatewayDevice.id = UUID.randomUUID
        l2GwConn.l2Gateway.gatewayDevice.resourceId = UUID.randomUUID
        l2GwConn.l2Gateway.gatewayDevice.gatewayType = GatewayType.ROUTER
        l2GwConn.l2Gateway.gatewayDevice.tunnelIps = new util.ArrayList()
