...
public class AdRoute extends UriResource {
     ...
     *            AdRoute data object
     */
    public AdRoute(com.midokura.midonet.cluster.data.AdRoute data) {
    ...
    public com.midokura.midonet.cluster.data.AdRoute toData () {

        try {
            return new com.midokura.midonet.cluster.data.AdRoute()
                    .setId(this.id)
                    .setBgpId(this.bgpId)
