...
public abstract class TunnelZone extends UriResource {
     ...
     */
    public TunnelZone(com.midokura.midonet.cluster.data.TunnelZone
                              tunnelZoneData) {
    ...
    public abstract com.midokura.midonet.cluster.data.TunnelZone toData();
     ...
     */
    public void setConfig(com.midokura.midonet.cluster.data.TunnelZone data) {
        data.setId(this.id);
