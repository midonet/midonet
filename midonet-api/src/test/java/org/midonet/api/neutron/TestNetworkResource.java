...
import org.midonet.cluster.rest_api.neutron.resources.NetworkResource;
...
public class TestNetworkResource extends ResourceTest {
    ...
    public void setUp() throws Exception {
        ...
        testObject = new NetworkResource(uriInfo, plugin);
    }
    ...
    public void testCreateConflict() throws Exception {
        ...
        doThrow(ConflictHttpException.class).when(plugin).createNetwork(
                any(Network.class));
    ...
    public void testUpdateNotFound() throws Exception {
        ...
        doThrow(NotFoundHttpException.class).when(plugin).updateNetwork(
