 ...
 */
package org.midonet.api.vpn.rest_api;
...
public class TestVpnResource {
    ...
    public void setUp() throws Exception {
        testObject = new VpnResource(config, uriInfo, context, auth,
                dataClient);
    }
    ...
    public void testDeleteNonExistentData() throws Exception {
        ...
        doReturn(null).when(dataClient).vpnGet(id);

        // Execute
        testObject.delete(id);

        // Verify
        verify(dataClient, never()).vpnDelete(id);
    }
