...
public class JerseyGuiceTestServletContextListener extends
    ...
    /**
     * Provide the backdoor to access the raw storage, through an
     * implementation agnostic interface.
     */
    public static TopologyBackdoor getTopologyBackdoor() {
        return _injector.getInstance(TopologyBackdoor.class);
    }
