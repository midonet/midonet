...
public class Topology {
    ...
    public static class Builder {
        ...
        public Builder create(String tag, BridgeData obj) {
        ...
        public Topology build() {
            ...
            for (Map.Entry<String, BridgeData> entry : bridges.entrySet()) {

                BridgeData obj = entry.getValue();
                ...
                obj = resource.postAndVerifyCreated(app.getBridges(),
                    APPLICATION_BRIDGE_JSON, obj, BridgeData.class);
                entry.setValue(obj);
            }
    ...
    public BridgeData getBridge(String tag) {
