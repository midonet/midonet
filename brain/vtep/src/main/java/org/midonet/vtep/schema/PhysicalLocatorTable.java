...
public final class PhysicalLocatorTable extends Table {
    ...
    public PhysicalLocator parsePhysicalLocator(Row<GenericTableSchema> row) {
        return parseEntry(row, PhysicalLocator.class);
    }
    ...
    public Insert<GenericTableSchema> insertPhysicalLocator(PhysicalLocator loc) {
        return insert(loc, PhysicalLocator.class);
    }
}
