 ...
 */
public class PhysicalSwitchTable extends Table {
    static protected final String COL_NAME = "name";
    static protected final String COL_DESCRIPTION = "description";
    static protected final String COL_PORTS = "ports";
    static protected final String COL_MANAGEMENT_IPS = "management_ips";
    static protected final String COL_TUNNEL_IPS = "tunnel_ips";
    ...
    public PhysicalSwitch parsePhysicalSwitch(Row<GenericTableSchema> row) {
        return new PhysicalSwitch(parseUuid(row), parseName(row),
                                  parseDescription(row), parseTunnelIps(row));
    }
}
