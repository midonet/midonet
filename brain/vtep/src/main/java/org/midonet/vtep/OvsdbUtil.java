...
public class OvsdbUtil {
     ...
     */
    static public GenericTableSchema getTblSchema(DatabaseSchema dbs,
                                                  String tblName)
    ...
    static public Expectation<OperationResult> singleOp(OvsdbClient client,
        ...
        Futures.addCallback(transaction.execute(), cb,
                            CallingThreadExecutor.getInstance());
        return result;
    }
    ...
    static public Expectation<Collection<Row<GenericTableSchema>>> query(
        ...
        }, CallingThreadExecutor.asExecutionContext());
        return result;
    }
     ...
     */
    static public Expectation<UUID> modify(final OvsdbClient client,
                                           Table table,
                                           Insert<GenericTableSchema> op) {
        final Expectation<UUID> result = new Expectation<>();
        Expectation<OperationResult> opResult =
            singleOp(client, table.getDbSchema(), op);
        opResult.onComplete(new Expectation.OnComplete<OperationResult>() {
            @Override
    ...
    /**
     * Convert to Ovsdb UUIDs to Java UUIDs
     */
    static public java.util.UUID toJavaUUID(UUID id) {
        return java.util.UUID.fromString(id.toString());
    }

    /**
     * Convert to Java UUIDs to Ovsdb UUIDs
     */
    static public UUID fromJavaUUID(java.util.UUID uuid) {
        return new UUID(uuid.toString());
    }

    /**
     * Generate an ovsdb random UUID
     */
