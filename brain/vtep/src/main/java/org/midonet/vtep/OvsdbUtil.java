...
public class OvsdbUtil {
    ...
    static public Expectation<java.util.UUID> modify(final OvsdbClient client,
        ...
        opResult.onComplete(new Expectation.OnComplete<OperationResult>() {
            ...
            public void onSuccess(OperationResult r) {
                if (r.getCount() > 0)
                    result.success(fromOvsdbUUID(r.getUuid()));
                else
                    result.success(null);
            }
     ...
     */
    static public java.util.UUID fromOvsdbUUID(UUID id) {
     ...
     */
    static public UUID toOvsdbUUID(java.util.UUID uuid) {
     ...
     */
    static public UUID randomOvsdbUUID() {
        return toOvsdbUUID(java.util.UUID.randomUUID());
    }
}
