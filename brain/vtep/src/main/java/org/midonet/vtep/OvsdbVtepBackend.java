...
public class OvsdbVtepBackend {
    ...
    public Observable<UcastMacEntryUpdate> localUcastMacUpdates() {
        return (Observable<UcastMacEntryUpdate>)macUpdates(ucastMacsLocalTable);
    }
    ...
    public Observable<UcastMacEntryUpdate> remoteUcastMacUpdates() {
        return (Observable<UcastMacEntryUpdate>)macUpdates(ucastMacsRemoteTable);
    }
    ...
    public Observable<McastMacEntryUpdate> localMcastMacUpdates() {
        return (Observable<McastMacEntryUpdate>)macUpdates(mcastMacsLocalTable);
    }
    ...
    public Observable<McastMacEntryUpdate> remoteMcastMacUpdates() {
        return (Observable<McastMacEntryUpdate>)macUpdates(mcastMacsRemoteTable);
    }
}
