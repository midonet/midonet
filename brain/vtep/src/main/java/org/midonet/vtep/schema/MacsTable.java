...
public abstract class MacsTable extends Table {
    ...
    /** Convenience method to guarantee that we only insert one row per
     * mac-ip combination (note that this is only effective for the tables
     * updated by us (i.e. remote mac tables)
     */
