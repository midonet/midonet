 ...
 */
public class ApiServerHandler extends SimpleChannelInboundHandler<Commons.UUID> {
    private static final Logger log =
        LoggerFactory.getLogger(ApiServerHandler.class);

    private final Subject<Request, Request> subject;

    public ApiServerHandler(Subject<Request, Request> subject) {
