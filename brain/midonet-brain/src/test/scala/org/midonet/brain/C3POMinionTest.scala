...
class C3POMinionTest extends FlatSpec with BeforeAndAfter
    ...
    it should "handle Subnet CRUD" in {
        ...
        dhcp.getOpt121Routes(0).getDstSubnet shouldBe IPSubnetUtil.toProto(hrDest)
        dhcp.getOpt121Routes(0).getGateway shouldBe IPAddressUtil.toProto(hrNexthop)
        ...
        dhcp2.getOpt121Routes(0).getGateway shouldBe IPAddressUtil.toProto(dhcpPortIp)
