...
import org.midonet.vtep.model.VtepMAC.{UNKNOWN_DST, fromMac}
...
class VxlanGatewayManagerTest extends FlatSpec with Matchers
    ...
    "A bridge with local ports" should "process updates from VTEPs" in {
        ...
        val nMac2Remotes = vtep2MacRemotes.getOnNextEvents.size()
        ...
        vtep2MacRemotes.getOnNextEvents should have size nMac2Remotes
