...
class RouterTranslator extends NeutronTranslator[NeutronRouter] {
    ...
    /** Translate the operation on NeutronModel to a list of operations applied
      ...
      * first to the latter. */
    override def translate(op: NeutronOp[NeutronRouter]): List[Operation[_]] = {
        // TODO: Return non-empty list, preferably with correctly-translated ops
        List()
    }
}
