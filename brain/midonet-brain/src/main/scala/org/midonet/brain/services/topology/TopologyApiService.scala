...
import org.midonet.brain.services.topology.common.{PlainAdapter, ConnectionManager, WebSocketAdapter}
 ...
 */
class TopologyApiService(storage: Storage) extends AbstractService {
    ...
    private val sessionManager = new SessionInventory(storage)
    private val protocol = new ServerProtocolFactory(sessionManager)
