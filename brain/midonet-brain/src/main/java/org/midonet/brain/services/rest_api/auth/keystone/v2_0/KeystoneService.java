 ...
 */
package org.midonet.brain.services.rest_api.auth.keystone.v2_0;
...
import org.midonet.brain.services.rest_api.auth.InvalidCredentialsException;
...
import org.midonet.brain.services.rest_api.auth.keystone.KeystoneInvalidFormatException;
...
public class KeystoneService implements AuthService {
    ...
    /**
     * Gets a {@link org.midonet.brain.services.rest_api.auth.Tenant} object from Keystone server.
     *
     * @param id Tenant ID
     * @return {@link org.midonet.brain.services.rest_api.auth.Tenant} object
     * @throws AuthException
     */
    @Override
