 ...
 */
package org.midonet.brain.services.rest_api.neutron;
...
import static org.midonet.brain.services.rest_api.ResourceUriBuilder.buildIdTemplateUri;
import static org.midonet.brain.services.rest_api.ResourceUriBuilder.getRoot;
...
public class
    ...
    public static URI getNeutron(URI baseUri) {
        return fromUri(getRoot(baseUri)).path(NEUTRON).build();
    }

    // Network
    public static URI getNetworks(URI baseUri) {
        return fromUri(getNeutron(baseUri)).path(NETWORKS).build();
    }

    public static URI getNetwork(URI baseUri, UUID id) {
        return fromUri(getNetworks(baseUri)).path(id.toString()).build();
    }
    ...
    public static URI getSubnets(URI baseUri) {
        return fromUri(getNeutron(baseUri)).path(SUBNETS).build();
    }
    ...
    public static URI getPorts(URI baseUri) {
        return fromUri(getNeutron(baseUri)).path(PORTS).build();
    }

    public static URI getPort(URI baseUri, UUID id) {
        return fromUri(getPorts(baseUri)).path(id.toString()).build();
    }
    ...
    public static URI getRouters(URI baseUri) {
        return fromUri(getNeutron(baseUri)).path(ROUTERS).build();
    }

    public static URI getRouter(URI baseUri, UUID id) {
        return fromUri(getRouters(baseUri)).path(id.toString()).build();
    }
    ...
    public static String getAddRouterInterfaceTemplate(URI baseUri) {
        return buildIdTemplateUri(getRouters(baseUri)) + ADD_ROUTER_INTF;
    }

    public static String getRemoveRouterInterfaceTemplate(URI baseUri) {
        return buildIdTemplateUri(getRouters(baseUri)) + REMOVE_ROUTER_INTF;
    }

    public static URI getFloatingIps(URI baseUri) {
        return fromUri(getNeutron(baseUri)).path(FLOATING_IPS).build();
    }

    public static URI getFloatingIp(URI baseUri, UUID id) {
        return fromUri(getFloatingIps(baseUri)).path(id.toString()).build();
    }
    ...
    public static URI getSecurityGroups(URI baseUri) {
        return fromUri(getNeutron(baseUri)).path(SECURITY_GROUPS).build();
    }

    public static URI getSecurityGroup(URI baseUri, UUID id) {
        return fromUri(getSecurityGroups(baseUri)).path(id.toString()).build();
    }
    ...
    public static URI getSecurityGroupRules(URI baseUri) {
        return fromUri(getNeutron(baseUri)).path(SECURITY_GROUP_RULES).build();
    }
