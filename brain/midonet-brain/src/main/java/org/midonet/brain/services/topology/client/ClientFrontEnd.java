...
public class ClientFrontEnd extends AbstractService {
    ...
    public ClientFrontEnd(ChannelInboundHandlerAdapter adapter, String host,
                          int port) {
    ...
    protected void doStart() {
        ...
        try {
            ...
            log.info("Topology API client started");
            notifyStarted();
    ...
    protected void doStop() {
        log.info("Stopping Topology API client");
        ...
        log.info("Topology API client stopped");
        notifyStopped();
    }
}
