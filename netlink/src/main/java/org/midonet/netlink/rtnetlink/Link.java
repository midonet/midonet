...
public class Link implements AttributeHandler, Cloneable {
    ...
    public class IfinfoMsg implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            return this.ifi_family == that.ifi_family &&
                    this.ifi_pad == that.ifi_pad &&
                    this.ifi_type == that.ifi_type &&
                    this.ifi_index == that.ifi_index &&
                    this.ifi_flags == that.ifi_flags &&
                    this.ifi_change == that.ifi_change;
        }

        @Override
        public int hashCode() {
            return Objects.hashCode(ifi_family, ifi_pad, ifi_type, ifi_index,
