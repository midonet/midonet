...
class NetlinkConciergeTest extends FeatureSpec
                              with ShouldMatchers
    ...
    val requestReply = new NetlinkConcierge(reader, writer, maxRequests, replyBuf,
    ...
    feature ("Can make requests to a NetlinkConcierge") {
    ...
    feature ("Can get replies from a NetlinkConcierge") {
