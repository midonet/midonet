...
class BridgeResource @Inject()(resContext: ResourceContext,
    ...
    extends WithChainsResource[Bridge](resContext) {
    ...
    protected final override def idOf(bridge: Bridge): UUID =
        bridge.id
    protected final override def inboundFilterOf(bridge: Bridge): UUID =
        bridge.inboundFilterId
    protected final override def outboundFilterOf(bridge: Bridge): UUID =
        bridge.outboundFilterId
