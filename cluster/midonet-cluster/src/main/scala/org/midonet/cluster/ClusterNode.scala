...
object ClusterNode extends App {
    ...
    private val daemon = new Daemon(nodeId, minions)
    ...
    private val clusterNodeModule = new AbstractModule {
        override def configure(): Unit = {
            ...
            // and start
            minions foreach { m => bind(m._2).in(classOf[Singleton]) }
