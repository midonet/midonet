...
import org.midonet.cluster.rest_api.models.federation.{MidonetVtep, OvsdbVtep}
...
class OvsdbVtepInGroupResource @Inject()(vtepGroupId: UUID,
    ...
    protected override def listFilter = (vtep: OvsdbVtep) => {
        vtep.group == vtepGroupId
    }

    protected override def createFilter = (vtep: OvsdbVtep) => {
