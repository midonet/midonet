...
import org.midonet.cluster.rest_api.models.federation.OvsdbVtep
...
class OvsdbVtepInGroupResource @Inject()(vtepGroupId: UUID,
    ...
    protected override def listFilter(vteps: Seq[OvsdbVtep]): Seq[OvsdbVtep] =
        vteps filter { _.group == vtepGroupId }

    protected override def createFilter(to: OvsdbVtep): Ops = {
