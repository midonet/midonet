...
object FederationMediaTypes {
    ...
    final val MIDONET_BINDING_JSON = "application/vnd.org.midonet.MidonetBinding-v1+json"
    final val MIDONET_BINDING_COLLECTION_JSON = "application/vnd.org.midonet.collection.MidonetBinding-v1+json"
    ...
    final val OVSDB_BINDING_JSON = "application/vnd.org.midonet.OvsdbBinding-v1+json"
    final val OVSDB_BINDING_COLLECTION_JSON = "application/vnd.org.midonet.collection.OvsdbBinding-v1+json"
}
