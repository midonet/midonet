 ...
 */
package org.midonet.cluster.services.rest_api.models;
...
import org.midonet.cluster.services.rest_api.annotation.Resource;
import org.midonet.cluster.services.rest_api.annotation.ResourceId;
import org.midonet.cluster.services.rest_api.annotation.Subresource;
...
public class Bridge extends UriResource {
    ...
    public List<URI> getVxLanPorts() {
        return vxLanPortIds != null ?
               getUrisFor(ResourceUris.PORTS, vxLanPortIds) : null;
    }
