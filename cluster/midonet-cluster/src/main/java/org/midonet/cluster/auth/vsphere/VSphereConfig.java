 ...
 * TODO:
 *
 * This doesn't quite work, I'm just keeping it here because it needs to be
 * ported into the nsdb schema when vsphere for v2 is implemented.
 */
@ConfigGroup(VSphereConfig.GROUP_NAME)
public interface VSphereConfig {
