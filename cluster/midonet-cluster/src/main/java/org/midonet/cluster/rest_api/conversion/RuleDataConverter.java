...
public class RuleDataConverter {
    ...
    public static Rule fromData(org.midonet.cluster.data.Rule<?, ?> data,
        ...
        if (data instanceof LiteralRule) {
            ...
            org.midonet.cluster.data.rules.ReverseNatRule) {
            org.midonet.cluster.data.rules.ReverseNatRule typedData =
                (ReverseNatRule) data;
            if (typedData.isDnat()) {
        ...
        dto.properties = data.getProperties();
        dto.meterName = data.getMeterName();
        dto.setBaseUri(baseUri);

        ConditionDataConverter.setFromSimulation(dto, data.getCondition());
    ...
    public static org.midonet.cluster.data.Rule<?, ?> toData(Rule dto) {
        ...
        data.setProperties(dto.properties);
