...
public final class PhysicalPortTable extends Table<PhysicalPort> {
    ...
    /**
     * Insertion of the physical port information
     */
    @Override
    public Table.OvsdbInsert insert(PhysicalPort row, String id)
        throws IllegalArgumentException {
        Insert<GenericTableSchema> op = newInsert(row, id);
    ...
    @Override
    public Table.OvsdbDelete delete(PhysicalPort row)
        throws IllegalArgumentException {
        return deleteById(row.uuid());
    }
