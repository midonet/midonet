    ...
    "C3PO" should "set a route to GW for the floating IP." in {
        ...
        eventually {
            ...
            val vifPortWithFip = storage.get(classOf[NeutronPort],
                                             vifPortId).await()
            vifPortWithFip.hasFloatingIpId shouldBe true
            vifPortWithFip.getFloatingIpId shouldBe toProto(fipId)
        }
        ...
        eventually {
            ...
            updatedVifPort.hasFloatingIpId shouldBe true
            updatedVifPort.getFloatingIpId shouldBe toProto(fipId)
        }
        ...
        eventually {
            ...
            val vifPortWithFipRemoved = storage.get(classOf[NeutronPort],
                                                    vifPortId).await()
            vifPortWithFipRemoved.hasFloatingIpId shouldBe false
        }
