 ...
 */
class NeutronApiTranslatorException(val operation: OpType.Value,
...
abstract class NeutronApiTranslator[T, M <: Object](
     ...
     */
    @throws[NeutronApiTranslatorException]
    def toMido(op: OpType, neutronModel: T): List[MidoModelOp]

    /**
     * Unified exception handling.
     */
    protected def handleExceptions(e: Exception,
                                   op: OpType.Value) = {
        throw new NeutronApiTranslatorException(op, neutronModelClass, e)
    }
