...
object ZoomConvert {
    ...
    /**
     * Returns the classea and the fields from the inheritance hierarchy of the
     * specified class, which are annotated with the [[ZoomField]] annotation.
     * @param pojoClass The class.
     * @return The fields as a set of [[FieldInfo]] instances containing the
     *         Java [[Field]] and [[ZoomField]] annotation. The set is organized
     *         as a [[Seq]] of [[Seq]], where the index in the first sequence
     *         indicates the level in inheritance hierarchy, with zero being the
     *         one corresponding to the top class.
     */
