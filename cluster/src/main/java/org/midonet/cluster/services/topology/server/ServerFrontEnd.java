...
public class ServerFrontEnd extends AbstractService {
    ...
    protected void doStart() {
        log.info("Starting Topology API server on port {}", port);
        try {
            ...
            log.info("Topology API server started");
            notifyStarted();
        } catch (InterruptedException e) {
            log.warn("Topology API server start interrupted");
    ...
    protected void doStop() {
        log.info("Stopping Topology API server");
        ...
        log.info("Topology API server stopped");
        notifyStopped();
    }
}
