...
public class ZoomObjectTest {
    ...
    public void testConversionForByteFields() {
        ...
        assertTrue(pojo.equals(convertedPojo));
    }
    ...
    static void assertByteSet(Set<Byte> pojoSet, List<Integer> protoList) {
        assertEquals(pojoSet.size(), protoList.size());
        for (Integer elem: protoList) {
            assertTrue(pojoSet.contains(elem.byteValue()));
        }
    }
