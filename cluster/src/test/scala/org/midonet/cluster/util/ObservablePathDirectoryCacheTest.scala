...
class ObservablePathDirectoryCacheTest extends FeatureSpec
    ...
    feature("Test observable completion") {
        scenario("Observable completes on close") {
            createParent()
    ...
    feature("Test observable errors") {
        ...
        scenario("Error on connect failure") {
            ...
            obs.getOnNextEvents shouldBe empty
            obs.getOnErrorEvents.get(0).getClass shouldBe classOf[CacheDisconnectedException]
        }
