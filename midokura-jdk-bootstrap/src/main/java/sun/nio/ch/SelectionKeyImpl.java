    ...
    extends AbstractSelectionKey
{
    ...
    public final SelectorImpl selector;                 // package-private
    ...
    public void nioReadyOps(int ops) {                 // package-private
        readyOps = ops;
    }

    public int nioReadyOps() {                         // package-private
        return readyOps;
    }

    public SelectionKey nioInterestOps(int ops) {      // package-private
    ...
    public int nioInterestOps() {                       // package-private
        return interestOps;
    }
