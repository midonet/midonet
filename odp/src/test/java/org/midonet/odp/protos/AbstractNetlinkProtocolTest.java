...
public abstract class AbstractNetlinkProtocolTest {
    ...
    protected void setConnection() throws Exception {
         OvsNetlinkFamilies families = new OvsNetlinkFamilies(
             new DatapathFamily((short)0), new PortFamily((short)0),
             new FlowFamily((short)0),  new PacketFamily((short)0), 0, 0);
        connection = new OvsDatapathConnectionImpl(channel, families,
