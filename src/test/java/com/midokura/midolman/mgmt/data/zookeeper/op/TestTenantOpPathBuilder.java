/*
 * @(#)TestTenantOpPathBuilder        1.6 12/1/6
 *
...
public class TestTenantOpPathBuilder {

    private ZkManager zkDaoMock = null;
    private PathBuilder pathBuilderMock = null;
    private TenantOpPathBuilder builder = null;
    ...
    public void setUp() throws Exception {
        ...
        builder = new TenantOpPathBuilder(zkDaoMock, pathBuilderMock);
    }
