/*
 * @(#)TestBridgeOpPathBuilder        1.6 12/1/6
 *
...
public class TestBridgeOpPathBuilder {
    ...
    private BridgeOpPathBuilder builder = null;
    ...
    public void setUp() throws Exception {
        ...
        builder = new BridgeOpPathBuilder(zkDaoMock, pathBuilderMock,
                serializerMock);
    }
