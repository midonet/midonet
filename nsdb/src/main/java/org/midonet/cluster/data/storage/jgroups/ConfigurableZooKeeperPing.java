...
public class ConfigurableZooKeeperPing extends AbstractZooKeeperPingNew {
    // The protocol id should be larger than 1024
    protected static short  CONFIGURABLE_ZK_PING_ID = 1025;
    ...
    static {
        ClassConfigurator.addProtocol(CONFIGURABLE_ZK_PING_ID,
                                      ConfigurableZooKeeperPing.class);
    }

    public ConfigurableZooKeeperPing() {}
