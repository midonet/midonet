...
import org.midonet.cluster.flowstate.proto.FlowState.{Trace, Nat, Conntrack}
...
trait FlowStatePackets[ConnTrackKeyT <: ConnTrackKeyStore,
    ...
    def natKeyFromSbe(nat: FlowStateSbe.Nat): NatKeyT
    ...
    def traceFromSbe(trace: FlowStateSbe.Trace): TraceKeyT
...
object FlowStateStorePackets
    ...
    override def connTrackKeyFromSbe(conntrack: Conntrack): ConnTrackKeyStore = {
        ConnTrackKeyStore(ipFromSbe(conntrack.srcIpType, conntrack.srcIp),
                          conntrack.srcPort,
    ...
    override def natKeyFromSbe(nat: Nat): NatKeyStore = {
        NatKeyStore(natKeyTypeFromSbe(nat.keyType),
    ...
    override def traceFromSbe(trace: Trace): TraceKeyStore = {
        TraceKeyStore(macFromSbe(trace.srcMac),
