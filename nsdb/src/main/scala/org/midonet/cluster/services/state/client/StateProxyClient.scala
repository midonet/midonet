...
/**
  ...
  *
  * In the presence on network failure, reconnections will be attempted spaced
  * by conf.softReconnectDelay. Up to conf.maxSoftReconnectAttempts will be
  * attempted before emitting a Disconnected state.
  *
  * Once in the disconnected state, all State Table subscribers will be
  * completed and will keep trying to contact a remote server using
  * hardReconnectDelay.
  */
