...
import org.midonet.cluster.services.discovery.MidonetDiscovery.{discoveryPath, serviceDiscoveryLog}
...
class MidonetDiscovery[P] (@Inject curator: CuratorFramework,
    ...
    log.debug("Midonet Discovery root path: " + curator.getNamespace + discoveryPath)
