 ...
 * to use it any more.
 */
final class MidonetServiceClient[Payload: ClassTag](
    ...
    def getProviders: Array[Payload] = provider.getAllInstances.asScala
 ...
 * to use it any more.
 */
final class MidonetServiceObservableClient[Payload: ClassTag] protected[discovery](
    val serviceName: String, serviceDiscovery: ServiceDiscovery[Payload],
    ...
    private val updates =
        BehaviorSubject.create[Array[Payload]](Array[Payload]())
