...
/**
  ...
  * to use it any more.
  */
private[discovery] final class MidonetDiscoveryClient[S](
    ...
    private implicit def asMidonetService(instance: ServiceInstance[Void]): Option[S] = {
...
/**
  ...
  * expiration.
  */
private[discovery] final class MidonetServiceHandler(name: String,
