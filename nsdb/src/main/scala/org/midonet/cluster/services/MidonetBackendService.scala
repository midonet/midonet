...
import org.midonet.cluster.data.storage.state_table.{MergedMapStateTableStorage, StateTableStorage}
...
abstract class MidonetBackend extends AbstractService {
    ...
    def deviceStateStore: StateTableStorage
...
class MidonetBackendService @Inject() (backendCfg: MidonetBackendConfig,
    ...
    override def deviceStateStore: StateTableStorage = stateTableStorage
