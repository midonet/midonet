...
trait ZoomMetrics {
    ...
    /**
     * Increment the count of premature close of NodeObservable.
     */
    def incNodeObservablePrematureClose(): Unit
...
object BlackHoleZoomMetrics extends ZoomMetrics {
    ...
    override def incNodeObservablePrematureClose(): Unit = {}
...
class JmxZoomMetrics(zoom: ZookeeperObjectMapper, registry: MetricRegistry)
    ...
    private def registerMetrics(): Unit = {
        ...
        registry.register(metricPrefix + "NodeObservablePrematureCloseCount",
            new Gauge[Long] {
                @Override
                def getValue(): Long = {
