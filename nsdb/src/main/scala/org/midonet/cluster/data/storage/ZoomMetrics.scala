...
trait ZoomMetrics {
    ...
    def incObjectWatcherTriggeredObs[T](): Observer[T]
    def incClassWatchersTriggeredObs[T](): Observer[T]
}
...
object BlackHoleZoomMetrics extends ZoomMetrics {
    ...
    override def incObjectWatcherTriggeredObs[T](): Observer[T] =
        Observers.empty()
    override def incClassWatchersTriggeredObs[T](): Observer[T] =
        Observers.empty()
}
