 ...
 */
class StateException private[storage](val clazz: String, val id: String,
                                      val key: String, val value: String,
                                      val result: Int, msg: String = "")
    extends StorageException(
 ...
 */
class StateOwnershipException private[storage](clazz: String, id: String,
...
class StateConcurrencyException private[storage](clazz: String, id: String,
                                                 key: String, value: String,
                                                 result: Int)
    extends StateException(clazz, id, key, value, result)
