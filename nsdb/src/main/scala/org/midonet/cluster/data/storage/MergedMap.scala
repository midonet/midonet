 ...
 * with the middleware used to propagate opinions among the map participants.
 ...
 */
class MergedMap[K, V >: Null <: AnyRef](mapId: MapId, owner: String,
                                        executor: ExecutorService,
                                        storage: MergedMapStorage[K, V])
