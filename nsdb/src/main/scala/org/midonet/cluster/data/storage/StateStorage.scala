 ...
 *  client session.
 *  - [[KeyType.SingleLastWriteWinsFailFast]]
 *  Same as above except that state data is quickly removed when
 *  the entity that created them is deemed to be down. This is achieved by using
 *  a small ZooKeeper session timeout for this type of key.
 *  - [[KeyType.Multiple]]
...
object KeyType extends Enumeration {
    ...
    final val SingleLastWriteWinsFailFast = new KeyType(true, false, true)
