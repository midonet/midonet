...
class CachedZookeeperObjectMapper(config: MidonetBackendConfig,
    ...
    extends ZookeeperObjectState with ZookeeperStateTable with Storage with StorageInternals {

    private val zoom = new ZookeeperObjectMapper(config, namespace, curator,
                                                 failFastCurator, stateTables,
                                                 reactor, metrics)
    private val cache = 0

    override protected def objectPath(clazz: Class[_], id: ObjId): String = ???

    override protected val rootPath: String = zoom.rootPath
    override protected val zoomPath: String = zoom.zoomPath
    ...
    /**
      ...
      */
    override protected def internalObservable[T](clazz: Class[T], id: ObjId,
    ...
    /**
      ...
      * storage.
      */
    override def exists(clazz: Class[_],
                        id: ObjId): Future[Boolean] = ???
}
