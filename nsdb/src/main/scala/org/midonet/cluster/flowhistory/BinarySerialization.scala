...
class BinarySerialization {
    ...
    def bufferToFlowRecord(buffer: Array[Byte]): FlowRecord = {
        ...
        while (rulesIter.hasNext) {
            ...
            rules.add(new TraversedRule(uuid, result, matched))
        }
        ...
        while (devicesIter.hasNext) {
            ...
            val deviceType = device.`type` match {
                case SbeDeviceType.LOAD_BALANCER => DeviceType.LOAD_BALANCER
                case SbeDeviceType.POOL => DeviceType.POOL
                case SbeDeviceType.PORT_GROUP => DeviceType.PORT_GROUP
                case SbeDeviceType.BRIDGE => DeviceType.BRIDGE
