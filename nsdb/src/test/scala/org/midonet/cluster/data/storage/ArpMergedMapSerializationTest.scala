...
import org.midonet.cluster.data.storage.ArpTableMergedMap.{ArpMergedMapSerialization, MacTS}
import org.midonet.packets.{IPv4Addr, MAC}

@RunWith(classOf[JUnitRunner])
class ArpMergedMapSerializationTest extends FeatureSpec with BeforeAndAfter
                                    with Matchers {
