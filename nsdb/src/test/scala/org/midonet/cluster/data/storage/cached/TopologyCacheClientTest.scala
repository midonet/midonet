    ...
    feature("Nice failures") {
        scenario("invalid path") {
            ...
            exc.getMessage should be
                "Topology cache client got non-OK code: " + HttpResponseStatus.FORBIDDEN
