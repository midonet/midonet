...
class MergedMapTest extends FeatureSpec with BeforeAndAfter
    ...
    private class MyMergedMapStorage(id: MergedMapId, ownerId: String,
    ...
    before {
        ...
        val myStorage = new MyMergedMapStorage(new MergedMapId(UUID.randomUUID(),
                                                               MergedMapType.ARP),
                                               "owner", inputSubj, outputSubj)
        map = new MergedMap[String, String](myStorage)
    }
