...
class ZookeeperObjectMapperTest extends StorageTest with CuratorTestFramework
    ...
    protected override def createStorage = {
        new ZookeeperObjectMapper(ZK_ROOT, curator, Some(new MetricRegistry()))
    }
    ...
    feature("Metrics") {
        ...
        scenario("Triggered object watchers") {
            ...
            val zoom = storage.asInstanceOf[ZookeeperObjectMapper]
            zoom.objectWatcherTriggered shouldBe 1
            ...
            zoom.objectWatcherTriggered shouldBe 2
            ...
            zoom.objectWatcherTriggered shouldBe 3
            ...
            zoom.objectWatcherTriggered shouldBe 4
            ...
            zoom.objectWatcherTriggered shouldBe 5
            ...
            zoom.objectWatcherTriggered shouldBe 6
        }
        ...
        scenario("Triggered class watchers") {
            ...
            val zoom = storage.asInstanceOf[ZookeeperObjectMapper]
            zoom.classWatcherTriggered shouldBe 1
            ...
            zoom.classWatcherTriggered shouldBe 2
            ...
            zoom.classWatcherTriggered shouldBe 3
            ...
            zoom.classWatcherTriggered shouldBe 4
        }
    }
