...
class MergedMapBaseTest extends FeatureSpec with BeforeAndAfter
    ...
    private val inputSubj = PublishSubject.create[(String, String, String)]()
    private val outputSubj = PublishSubject.create[(String, String, String)]()
    ...
    before {
        map = new MergedMapBase[String, String](new MyMapId("myId"), "owner",
                                                executor, inputSubj, outputSubj)
    }
