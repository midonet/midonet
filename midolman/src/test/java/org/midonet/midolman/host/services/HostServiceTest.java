...
public abstract class HostServiceTest {
    ...
    ServiceCallbacks callbacks = new ServiceCallbacks();
    ...
    protected class ServiceCallbacks extends HostService.HostServiceCallbacks {
    ...
    private class TestModule extends AbstractModule {
        ...
        protected void configure() {
            bind(PathBuilder.class)
                .toInstance(new PathBuilder(config.getString("zookeeper.root_key")));
            ...
            bind(HostService.HostServiceCallbacks.class)
                .toInstance(callbacks);
        }
    ...
    HostService startService() throws Throwable {
    ...
    void startAndStopService() throws Throwable {
