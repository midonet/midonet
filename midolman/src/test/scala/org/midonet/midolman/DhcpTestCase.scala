...
object DhcpTestCase {
    ...
    private[midolman] def getMtu(ip: String): String = {
        ...
        // it should be at most 5 lines above on OSX and 2 lines below on linux
        val cmd = ( "/sbin/ifconfig | grep -A 2 -B 5 " + ip
            + "| egrep -o -i 'mtu(:| )[0-9]+'"
            // Reverse the output on both Linux and Mac OSX:
            //   http://stackoverflow.com/questions/742466#answer-13867870
