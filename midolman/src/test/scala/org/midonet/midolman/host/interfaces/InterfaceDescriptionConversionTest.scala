...
class InterfaceDescriptionConversionTest extends FlatSpec with Matchers {
    ...
    private val typeToPojo = Map(
        ProtoType.PHYSICAL_TYPE -> PojoType.PHYS,
        ProtoType.VIRTUAL_TYPE -> PojoType.VIRT,
        ProtoType.TUNNEL_TYPE -> PojoType.TUNN,
        ProtoType.UNKNOWN_TYPE -> PojoType.UNKNOWN)
    ...
    private val portTypeToPojo = Map(
        ProtoPortType.NET_DEV_DP_TYPE -> PojoPortType.NetDev,
        ProtoPortType.INTERNAL_DP_TYPE -> PojoPortType.Internal,
        ProtoPortType.GRE_DP_TYPE -> PojoPortType.Gre,
        ProtoPortType.VXLAN_DP_TYPE -> PojoPortType.VXLan,
        ProtoPortType.GRE64_DP_TYPE -> PojoPortType.Gre64,
        ProtoPortType.LISP_DP_TYPE -> PojoPortType.Lisp
    )
