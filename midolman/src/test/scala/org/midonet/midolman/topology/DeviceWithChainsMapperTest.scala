...
import org.midonet.cluster.data.storage.{CreateOp, NotFoundException, Storage, TestAwaitableObserver}
...
class DeviceWithChainsMapperTest extends MidolmanSpec with TopologyBuilder
    ...
    private def createObserver() = new TestAwaitableObserver[TestableDevice]
