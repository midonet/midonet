...
import org.midonet.cluster.models.Neutron.{VIP => NeutronVIP}
...
class LoadBalancerMapperTest extends MidolmanSpec
    ...
    private def assertVips(protoVips: List[NeutronVIP], simVips: Array[SimVIP])
    : Unit = {
    ...
    private def buildAndStoreVip(ip: String): NeutronVIP = {
