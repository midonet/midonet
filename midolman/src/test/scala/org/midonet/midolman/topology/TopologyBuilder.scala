...
trait TopologyBuilder {
    ...
    protected def createLiteralRuleBuilder(id: Commons.UUID,
    ...
    protected def createJumpRuleBuilder(id: Commons.UUID, chainId: Commons.UUID,
    ...
    : Chain.Builder = {
        Chain.newBuilder
            .setId(id)
            .setName(name)
            .addAllRuleIds(ruleIds.toIterable.asJava)
    }
