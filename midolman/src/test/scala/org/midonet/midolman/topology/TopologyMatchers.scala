...
import org.midonet.cluster.models.Topology.{IpAddrGroup => TopologyIPAddrGroup, Network => TopologyBridge, Port => TopologyPort, Route => TopologyRoute, Router => TopologyRouter, Rule => TopologyRule}
...
import org.midonet.midolman.simulation.{Bridge, IPAddrGroup, Router}
