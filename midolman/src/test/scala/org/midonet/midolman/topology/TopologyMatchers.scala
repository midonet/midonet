...
object TopologyMatchers {
    ...
    class BGPRouteMatcher(route: BGPAdRoute)
...
trait TopologyMatchers {
    ...
    implicit def asMatcher(route: BGPAdRoute): BGPRouteMatcher =
