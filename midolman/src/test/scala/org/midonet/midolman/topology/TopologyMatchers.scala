...
import org.midonet.cluster.models.Topology.{Chain => TopologyChain, IpAddrGroup => TopologyIPAddrGroup, LoadBalancer => TopologyLB, Network => TopologyBridge, Port => TopologyPort, PortGroup => TopologyPortGroup, Route => TopologyRoute, Router => TopologyRouter, Rule => TopologyRule, VIP => TopologyVIP}
