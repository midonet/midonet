...
class BridgeSimulationTest extends MidolmanSpec {
    ...
    scenario("bpdu topology change packets flush mac learning tables") {
        ...
        flowInvalidator should invalidate (FlowTagger.tagForVlanPort(
            bridge.getId, MAC.fromString("02:13:66:77:88:99"),
            Bridge.UntaggedVlanId, port1OnHost1.getId))
    }
