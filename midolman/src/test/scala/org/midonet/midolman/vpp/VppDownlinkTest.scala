...
/*
    feature("VPP downlink handles table completion") {
        scenario("The table is deleted") {
            ...
            vpp.messages should have size 4
            vpp.messages(2) shouldBe disassociateFip(port, entry, VppVrfs.FirstFree)
            vpp.messages(3) shouldBe DeleteTunnel(port.getId, VppVrfs.FirstFree, 1234)
        }
    }*/
/*
    feature("VPP downlink lifecycle") {
        ...
        scenario("Messages are received after restart") {
            ...
            vpp.messages should have size 2
            vpp.messages.head shouldBe createTunnel(port, VppVrfs.FirstFree, 1234,
                                                      downlinkMac)
            vpp.messages(1) shouldBe associateFip(port, entry, VppVrfs.FirstFree)
        }
        ...
        scenario("State is cleaned at stop") {
            ...
            vpp.messages should have size 6
            vpp.messages(4) shouldBe createTunnel(port2, VppVrfs.FirstFree, 1234,
                                                    downlinkMac)
            vpp.messages(5) shouldBe associateFip(port2, entry2, VppVrfs.FirstFree)
        }
    }*/
}
