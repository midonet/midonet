...
package object stream {
    ...
    : RingBuffer[ByteBuffer] = {
            ...
            new RingBuffer[ByteBuffer](config.blocksPerPort,
                                       null, lastBlock, firstBlock)
    }
    ...
    object ByteBufferBlockWriter {
        ...
        def apply(config: FlowStateConfig,
            ...
            var buffers: RingBuffer[ByteBuffer] = null
            ...
            new ByteBufferBlockWriter[TimedBlockHeader](FlowStateBlock, buffers,
                                                        config.expirationTime toMillis,
                                                        factory.allocate)
        }
    }
