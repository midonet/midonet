...
object FlowStateBlock extends BlockHeaderBuilder[TimedBlockHeader] {
    ...
    val EmptyMagicNumber = new Array[Byte](MagicNumber.array.length)
    //val MagicNumber =
    //    ByteBuffer.wrap(Array[Byte]('X', 'F', 'l', 'o', 'w', 'S', 't', 'a', 't', 'e'))
    ...
    def apply(buffer: ByteBuffer): FlowStateBlockHeader = {
