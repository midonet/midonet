...
object DatapathController extends Referenceable {
    ...
    private var defaultMtuInConfig: Short = MidolmanConfig.DEFAULT_MTU
    def DefaultMtu: Short = defaultMtuInConfig
...
class DatapathController extends Actor
    ...
    override def preStart(): Unit = {
        Option(midolmanConfig).foreach(conf =>
            defaultMtuInConfig = conf.getMidolmanDhcpMtu.toShort)
        super.preStart()
