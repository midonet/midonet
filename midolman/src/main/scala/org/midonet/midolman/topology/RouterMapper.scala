...
object RouterMapper extends Referenceable {
    override val Name: String = "RouterMapper"
}

class RouterMapper(id: UUID, vt: VirtualTopology, routerMgr: RouterZkManager,
                   routeMgr: RouteZkManager)(implicit actorSystem: ActorSystem)
    ...
    private class RouteEncoder {
        ...
        @Inject private var serializer: Serializer = _
    ...
    var reactorLoop: Reactor = _   // for some reason the constant doesn't work
