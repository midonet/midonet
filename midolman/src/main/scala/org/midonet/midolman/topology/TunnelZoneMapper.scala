...
import org.midonet.cluster.models.Topology.{Host => TopologyHost, TunnelZone => TopologyTunnelZone, Port}
import org.midonet.midolman.topology.devices.{Host => SimHost, TunnelZone => SimTunnelZone, Port}
