...
@ZoomClass(clazz = classOf[Devices.Port], factory = classOf[PortFactory])
...
sealed class PortFactory extends ZoomConvert.Factory[Port, Devices.Port] {
    override def getType(proto: Devices.Port): Class[_ <: Port] = {
