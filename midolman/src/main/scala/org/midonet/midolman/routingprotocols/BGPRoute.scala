...
import org.midonet.cluster.data.{BGP, AdRoute, ZoomObject}
...
object BGPRoute {
    /**
     * Creates a [[BGPRoute]] peering instance, corresponding to the Protocol
     * Buffers data model, from the legacy [[AdRoute]] using the ZooKeeper
     * managers serialization. This method will be removed when the legacy
