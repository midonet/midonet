...
/**
  ...
  */
class PipelinedSbeEncoderTranslator {
    ...
    // FIXME[mateo]: we don't make a difference between strong and weak connTrack
    // and nats when we use them, we should just keep them together in the batch
    def pushToPipeline(sbe: SbeEncoder): Unit = {
