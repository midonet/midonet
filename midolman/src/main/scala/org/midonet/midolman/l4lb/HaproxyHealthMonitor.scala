...
// TODO: Understand which executor should be used for the service
class HaproxyHealthMonitor(var config: PoolConfig,
    ...
    // TODO: replace this with the service container thread pool
    ...
    private val healthMonitorName = config.id.toString.substring(0,8) +
                                    config.nsPostFix
    private val log = LoggerFactory.getLogger("org.midonet.haproxyhealthmonitor")
    ...
    // TODO: Consolidate this in the HM companion object.
