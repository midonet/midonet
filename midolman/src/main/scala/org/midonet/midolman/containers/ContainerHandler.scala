...
trait ContainerHandler {
    ...
    /**
      ...
      * - IPSecAdminStateDownException: if all VPNServices associated to the
      *   container are in admin state DOWN.
      * - IPSecException: when we're unable to bring up the service.
      */
