        ...
        simRes match {
            ...
            case a =>
                ...
                val dstIp28 = {
                    ...
                    IPv4Addr(dstIp.toInt & 0xfffffff0)
                }

                context.addFlowTag(FlowTagger.tagForDestinationIp(id, dstIp28))
                routerMgrTagger.addIPv4Tag(dstIp28, matchLen)
                context.addFlowRemovedCallback(
                        routerMgrTagger.getFlowRemovalCallback(dstIp28))
        }
    }
