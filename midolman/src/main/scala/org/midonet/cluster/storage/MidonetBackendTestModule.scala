...
import org.midonet.cluster.data.storage.{StorageWithState, StorageWithOwnership, InMemoryStorage, Storage}
...
class MidonetTestBackend extends MidonetBackend {
    ...
    override def stateStore: StorageWithState = inMemoryZoom
