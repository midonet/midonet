...
public class Converter {
    ...
    public static com.midokura.midolman.layer3.Route toRouteConfig(
            Route route) {
        ...
        com.midokura.midolman.layer3.Route routeConfig =
                new com.midokura.midolman.layer3.Route(
    ...
    public static Route fromRouteConfig(
            com.midokura.midolman.layer3.Route route) {
    ...
    public static com.midokura.midolman.rules.Rule toRuleConfig(Rule rule) {

        com.midokura.midolman.rules.Rule ruleConfig = null;
        if (rule instanceof LiteralRule) {
            LiteralRule typedRule = (LiteralRule) rule;

            ruleConfig = new com.midokura.midolman.rules.LiteralRule(
        ...
        if (rule instanceof JumpRule) {
            ...
            ruleConfig = new com.midokura.midolman.rules.JumpRule(
                    typedRule.getCondition(),
        ...
        if (rule instanceof ForwardNatRule) {
            ...
            ruleConfig = new com.midokura.midolman.rules.ForwardNatRule(
                    typedRule.getCondition(),
                    typedRule.getAction(),
        ...
        if (rule instanceof ReverseNatRule) {
            ...
            ruleConfig = new com.midokura.midolman.rules.ReverseNatRule(
                    typedRule.getCondition(),
                    typedRule.getAction(),
                    typedRule.isDnat()
            );
    ...
    public static Rule fromRuleConfig(
            com.midokura.midolman.rules.Rule ruleConfig) {

        Rule rule = null;

        if (ruleConfig instanceof com.midokura.midolman.rules.LiteralRule) {
            rule = new LiteralRule(ruleConfig.getCondition(),
                    ruleConfig.action);
        }

        if (ruleConfig instanceof com.midokura.midolman.rules.JumpRule) {
            com.midokura.midolman.rules.JumpRule jumpRuleConfig =
                    (com.midokura.midolman.rules.JumpRule) ruleConfig;
        ...
        if (ruleConfig instanceof com.midokura.midolman.rules.ForwardNatRule) {
            com.midokura.midolman.rules.ForwardNatRule forwardNatRuleConfig =
                    (com.midokura.midolman.rules.ForwardNatRule) ruleConfig;
        ...
        if (ruleConfig instanceof com.midokura.midolman.rules.ReverseNatRule) {
            com.midokura.midolman.rules.ReverseNatRule reverseNatRuleConfig =
                    (com.midokura.midolman.rules.ReverseNatRule) ruleConfig;
    ...
    public static com.midokura.midonet.cluster.data.dhcp.Host fromDhcpHostConfig
            (BridgeDhcpZkManager.Host hostConfig) {
        return new com.midokura.midonet.cluster.data.dhcp.Host()
    ...
    public static BridgeDhcpZkManager.Subnet toDhcpSubnetConfig(
        ...
        return new BridgeDhcpZkManager.Subnet(subnet.getSubnetAddr(),
                ...
                subnet.getDnsServerAddr(), subnet.getInterfaceMTU(), opt121Configs);
    }
