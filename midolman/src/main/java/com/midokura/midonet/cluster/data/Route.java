...
public class Route extends Entity.Base<UUID, Route.Data, Route> {
    ...
    public com.midokura.midolman.layer3.Route.NextHop getNextHop() {
        return getData().nextHop;
    }

    public Route setNextHop(
            com.midokura.midolman.layer3.Route.NextHop nextHop) {
    ...
    public static class Data {
        ...
        public com.midokura.midolman.layer3.Route.NextHop nextHop;
