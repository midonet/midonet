// NOTE(yamamoto): This is a modified copy of ServerConnector from
// jetty-9.3.3.v20150827, adapted for UnixDomainServerSocketChannel.
...
package org.midonet.services.agent_rest_api.hacks;
...
import org.midonet.services.agent_rest_api.hacks.UnixDomainServerSocketChannel;
...
public class UnixDomainServerConnector extends AbstractNetworkConnector
{
     ...
     * <p>Construct a UnixDomainServerConnector with a private instance of {@link HttpConnectionFactory} as the only factory.</p>
    ...
    /* ------------------------------------------------------------ */
    /** HTTP Server Connection.
     * <p>Construct a UnixDomainServerConnector with a private instance of {@link HttpConnectionFactory} as the primary protocol</p>.
     * @param server The {@link Server} this connector will accept connection for. 
    ...
    {
        return new UnixDomainServerConnectorManager(executor, scheduler, selectors);
    }
    ...
    public void setAcceptChannel(UnixDomainServerSocketChannel channel)
    {
        _acceptChannel = channel;
    }
    ...
    public void open() throws IOException
    {
        if (_acceptChannel == null)
        {
            ...
            {
                serverChannel = UnixDomainServerSocketChannel.open();
                SocketAddress sa = new AfUnix.Address(_unixSocket);
                serverChannel.bind(sa, getAcceptQueueSize());
    ...
    protected class UnixDomainServerConnectorManager extends SelectorManager
    {
        public UnixDomainServerConnectorManager(Executor executor, Scheduler scheduler, int selectors)
        {
