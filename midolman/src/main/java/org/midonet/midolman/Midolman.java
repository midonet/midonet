...
public class Midolman {
    ...
    private void run(MidoNodeConfigurator configurator, String[] args)
            throws Exception {
    ...
    public static void main(String[] args) {
        try {
            ...
            MidoNodeConfigurator configurator = getConfiguratorFromArgs(args);
            midolman.run(configurator, args);
