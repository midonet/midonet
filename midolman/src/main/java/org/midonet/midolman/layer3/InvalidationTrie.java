...
public class InvalidationTrie extends RoutesTrie {
    ...
    /**
     * Returns all destination IP addresses that are descendants to a given
     * invalidation trie node.
     *
     ...
     * destination IP addresses that are below this node, and should be
     * invalidated when the route has changed.
     */
