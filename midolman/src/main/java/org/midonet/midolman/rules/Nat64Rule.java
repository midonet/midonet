...
public class Nat64Rule extends Rule {
    ...
    public int hashCode() {
        ...
        result = 31 * result + (portAddress == null ? 0 : portAddress.hashCode());
        result = 31 * result + (natPool == null ? 0 : natPool.hashCode());
        return result;
    }
    ...
    public boolean equals(Object other) {
        ...
        return Objects.equals(portAddress, r.portAddress) &&
               Objects.equals(natPool, r.natPool);
    }
