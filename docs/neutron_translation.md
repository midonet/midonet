...
BridgePort's in-mirrors/out-mirrors might be more straightforward
if we don't care about compatibility with the reference implementation
wrt tapping "position".
