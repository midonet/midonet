...
If 'del_bgp_peer_ids' is set, either BGP peer was deleted or removed from the
BGP speaker.  The MidoNet and high level BGP peer models with IDs included in
this field are deleted.
