...
To use MidoNet Metadata Proxy, you need to configure and enable it
via mn-conf.  These are deployment-global setting.  They will take
effect next time each midolman (re-)started.
