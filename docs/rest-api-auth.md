...
<pre><code>
  ...
  &lt;context-param&gt;
    ...
    &lt;param-value&gt;
      org.midonet.brain.services.rest_api.auth.MockAuthService
    &lt;/param-value&gt;
  &lt;/context-param&gt;
  ...
</code></pre>
...
<i>org.midonet.brain.services.rest_api.auth.AuthService</i> interface.  In the example above,
<i>org.midonet.brain.services.rest_api.auth.MockAuthService</i> class is specified which is a
...
<i>org.midonet.brain.services.rest_api.auth.keystone.v2_0.KeystoneService</i>.
