...
test_ipv6.test_ping_multi_vms_ipv6.gate = 1
test_ipv6.test_neutron_fip6.gate = 1
...
test_ipv6.test_fragments.gate = 1
test_ipv6.test_dual_stack_external_network.gate = 1
test_ipv6.test_dual_stack_uplink.gate = 1
