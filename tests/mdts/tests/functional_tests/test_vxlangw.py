...
@bindings(bindings_single_mm_multi_bridge_same_subnet, bindings_multi_mm)
@with_setup(setup_single_vtep, clear_single_vtep)
...
@bindings(bindings_single_mm_multi_bridge_diff_subnet, bindings_multi_mm)
