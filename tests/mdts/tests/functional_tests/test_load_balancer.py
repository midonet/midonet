...
def test_multi_member_loadbalancing():
    ...
    # The probability of hitting all 3 backends at least once with n requests is
    # formulated in the coupon collector's problem (see Wikipedia for instance).
