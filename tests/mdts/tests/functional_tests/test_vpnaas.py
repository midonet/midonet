...
def test_ipsec_container_failover():
    ...
    # Namespaces are not cleaned up when loosing connection to ZK. So namespaces
    # are not removed which may cause problems when recovering the connection.
    # We should be able to go back to midolman2 instead of using a non previously
    # failed host.
    # midolman2.eject_package_loss('eth0')
