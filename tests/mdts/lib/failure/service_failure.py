...
class ServiceFailure(FailureBase):
    ...
    """
    def __init__(self, service_hostname, iface_name='eth0'):
        super(ServiceFailure, self).__init__("%s failure" % service_hostname)
    ...
    def inject(self):
        self.service.inject_interface_failure(self.iface_name)
        self.service.wait_for_status('down')

    def eject(self):
        self.service.eject_interface_failure(self.iface_name)
        self.service.wait_for_status('up')
