...
import exceptions
from neutron.plugins.midonet import plugin as plugin_v1
...
class MigrationConfig(object):
    def __init__(self, v2_plugin=False):
        try:
            cfg.CONF(
                args=[],
                project='neutron',
        ...
        if v2_plugin:
            ...
            self.client = plugin_v1.MidonetPluginV2()
    ...
    def mn_get_objects(self, path=None, full_url=None, media_type="*/*"):
        ...
        data = self.mn_client.get(uri=get_path, media_type=media_type)
        return data
