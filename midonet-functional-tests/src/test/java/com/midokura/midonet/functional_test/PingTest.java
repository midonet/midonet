...
public class PingTest {
    ...
    IntIPv4 rtrIp1 = IntIPv4.fromString("192.168.231.1", 24);
    IntIPv4 rtrIp2 = IntIPv4.fromString("192.168.232.1", 24);
    IntIPv4 ip1 = IntIPv4.fromString("192.168.231.2", 24);
    IntIPv4 ip2 = IntIPv4.fromString("192.168.232.2", 24);
    ...
    public void setUp() throws Exception {
        ...
        helper1 = new PacketHelper(MAC.fromString("02:00:00:aa:aa:01"), ip1,
            rtrIp1);
        sleepBecause("Cause we're tired", 5);
    }
