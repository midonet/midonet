...
public class SecurityGroupTest {
    ...
    public void setUp() throws IOException, InterruptedException {
        ...
        BridgePort bPort1 = bridge1.addPort(null, portOutChain1.chain.getId());
        ...
        portOutChain2.addRule().setPosition(2)
                .setSimpleType(DtoRule.Drop).build();
        BridgePort bPort2 = bridge1.addPort(null, portOutChain2.chain.getId());
        ...
        portOutChain3.addRule().setPosition(3)
                .setSimpleType(DtoRule.Drop).build();
        BridgePort bPort3 = bridge1.addPort(null, portOutChain3.chain.getId());
        ...
        BridgePort bPort4 = bridge1.addPort();
